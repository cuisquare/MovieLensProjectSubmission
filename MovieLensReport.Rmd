...
Using a model that incorporated the effects of movie, user, date of rating, individual genres and release year to account for the variation in ratings, it was possible to reach predictions in movie ratings for unseen data with a RMSE below 0.84, beating the lowest RMSE target of `r rmse_target_25` with a significant margin.
